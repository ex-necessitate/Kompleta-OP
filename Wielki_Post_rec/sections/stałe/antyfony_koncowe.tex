...
\V{Módlmy się. Prosimy Cię, Panie Boże, dozwól nam, sługom swoim, cieszyć się trwałym zdrowiem duszy i ciała, \comm{†}
a za przyczyną Najświętszej Maryi zawsze Dziewicy,~\comm{*}
...
Deus, perpétua mentis et corporis salute gaudére~\comm{*} et gloriosa beatae Mariae semper Virginis intercessione a praesénti liberari tristitia \comm{†} et aetérna pérfrui laetitia. Per Christum Dominum nostrum.}
\R{Amen.}
...
Spraw, prosimy wszechmogący Boże,~\comm{†}
niechaj wstawiennictwo błogosławionego Dominika,
Wyznawcy Twego, Ojca naszego, \comm{*}
...
\V{Oremus. Concéde, quaésumus, omnipotens Deus~\comm{*} ut qui
peccatorum nostrorum pondere prémimur, \comm{†} beati Dominici confessoris tui, Patris nostri, patrocinio sublevémur. Per Christum Dominum nostrum.}
\R{Amen.}
...
\clearpage
\noindent\V{Módlmy się.
Boże, któryś raczył wsławić błogosławionego Jacka,
wyznawcę Twego, chwałą cudów i świątobliwymi dziełami w krajach różnych narodów,~\comm{†} daj nam,
abyśmy za Jego przykładem życie nasze poprawili \comm{*}
i w przeciwnościach byli bronieni Jego pomocą.
Przez Chrystusa Pana naszego.}
\R{Amen.}
\subsection*{Zakończenie łacińskie}
\noindent
...
\R{Ut digni efficiamur promissionibus Christi.}
\V{Oremus. Deus, qui beatum Hyacinthum, Confessorem tuum, in diversis nationum populis operum sanctitate et miraculorum gloria fecisti conspicuum: \comm{*} da nobis ut ejus in melius reformemur exemplis, \comm{†} et in adversis protegamur auxiliis. Per Christum Dominum nostrum.}
\R{Amen.}
